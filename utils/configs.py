...
# --- ST-PPGN ---
parser.add_argument('--stppgn_k_neighbors', type=int, default=64,
                    help='Number of K-nearest neighbors for graph construction in ST-PPGN.')
parser.add_argument('--stppgn_prop_layers', type=int, default=2,
                    help='Number of spatio-temporal propagation layers in ST-PPGN.')
parser.add_argument('--stppgn_channel_dim', type=int, default=64,
                    help='Dimension of the channel embedding (d_c) in ST-PPGN.')
parser.add_argument('--stppgn_time_dim', type=int, default=64,
                    help='Dimension of the time encoding (d_t) in ST-PPGN.')
parser.add_argument('--stppgn_mlp_ratio', type=float, default=2.0,
                    help='Ratio of the hidden dimension to the model dimension in all MLPs for ST-PPGN.')
parser.add_argument('--stppgn_channel_dist_weight', type=float, default=1.0,
