...
def find_top_n_average_runs(search_dir, n=10):
    ...
    # 定义分组前缀
    PREFIXES = {
        'sl72_pl3': 'Warpformer_MIMIC_III_sl72_pl3_',
        'sl3000_pl300': 'GraFITi_HumanActivity_sl3000_pl300_',
        'sl2160_pl3': 'GraFITi_MIMIC_IV_sl2160_pl3_',
        'sl36_pl3': 'GraFITi_P12_sl36_pl3_',
        'sl150_pl3': 'GraFITi_USHCN_sl150_pl3'
    }
